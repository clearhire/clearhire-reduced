...
app.layout = html.Div(style={'backgroundColor': '#3c73a8'}, children=[
    ...
    html.Div(
        ...
        children=['You want to apply for a new job. ClearHire allows you to explore different algorithms and explanations for job recommendations to find the one that suits you best. To get started:', 
                    ...
                    html.Br(), html.Br(), 'Step 2: Click SUBMIT',
                    html.Br(), html.Br(), 'Step 3: Scroll down to see four different lists of job recommendations, based on the jobs you selected']
    ),
            ...
            html.Div(
                ...
                children=['Below are the four list of job recommendations based on your selections.',
                            ...
                            html.Ul(children=[
                                    ...
                                    html.Li('For each job, Option 2  provides a tailored explanation of the average qualifictions of users who have previously applied to that job.'),
                                    html.Li('In the box above the recommendation list, Option 3 provides an explanation of how Algorithm B produces its results. It then describes the average qualifications of the users to who Algorithm B considers you similar.'),
                                    html.Li('In the box above the recommendation list, Option 4 provides an explanation of how Algorithm C produces its results. For each job it then provides a tailored explanation about why you are being recommended that job.')
                            ]),
                        ]
            ),
